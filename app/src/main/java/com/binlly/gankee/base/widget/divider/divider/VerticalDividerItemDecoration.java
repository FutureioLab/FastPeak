...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    protected Rect getDividerBound(int position, RecyclerView parent, View child) {
        ...
        bounds.bottom = parent.getHeight() - parent.getPaddingBottom() - mMarginProvider.dividerBottomMargin
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<Builder> {
        ...
        public Builder marginResId(@DimenRes int topMarginId, @DimenRes int bottomMarginId) {
            return margin(mResources.getDimensionPixelSize(topMarginId), mResources.getDimensionPixelSize
                    (bottomMarginId));
        }
